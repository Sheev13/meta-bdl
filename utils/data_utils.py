...
def obtain_me_a_nice_sawtooth_dataset_please(x_range=[-4.0, 4.0], n_range=[5, 100], noise=0.05, noise_range=None, p=1.0, p_range=None, random_shift=False, random_gradient=False):
