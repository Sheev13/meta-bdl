...
python experiments/1d_regressions/1d_regressions.py --function_type heaviside --nonlinearity tanh --architecture 50 50 --training_steps 20_000 --loss_function p-avi --num_samples 8 --learning_rate 1e-3 --final_learning_rate 5e-5 --train_new_model --use_gpu