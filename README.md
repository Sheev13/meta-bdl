...
N.B. the primary model is referred to as the BNNP in the paper. At an earlier point in the project, it was called the BDNP. Some code within the experiments folder of the codebase still reflects this. Sorry about that.
