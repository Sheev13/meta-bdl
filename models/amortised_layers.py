...
from base_networks.set_architectures import Transformer

class AmortisedLinearLayer(nn.Module):
    def __init__(self,
                 x_dim: int,
                 y_dim: int,
                 d_in: int,
...
class AmortisedAttentionLayer(nn.Module):
    ...
    def __init__(self,
        ...
        self.q_proj = AmortisedLinearLayer(x_dim, y_dim, d_emb, d_emb, prior_type=1, inf_dims=inf_dims, nonlinearity=nn.Identity(), inf_net_use_act=inf_net_use_act)
        self.k_proj = AmortisedLinearLayer(x_dim, y_dim, d_emb, d_emb, prior_type=1, inf_dims=inf_dims, nonlinearity=nn.Identity(), inf_net_use_act=inf_net_use_act)
        self.v_proj = AmortisedLinearLayer(x_dim, y_dim, d_emb, d_emb, prior_type=1, inf_dims=inf_dims, nonlinearity=nn.Identity(), inf_net_use_act=inf_net_use_act)
        self.out_proj = AmortisedLinearLayer(x_dim, y_dim, d_emb, d_emb, prior_type=1, inf_dims=inf_dims, nonlinearity=nn.Identity(), inf_net_use_act=inf_net_use_act)
...
class AmortisedAttentionBlock(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.bdap_layer = AmortisedAttentionLayer(x_dim, y_dim, d_emb, num_heads=num_heads, inf_dims=inf_dims, inf_net_use_act=inf_net_use_act)
        self.ln1 = nn.LayerNorm(d_emb)
        self.ln2 = nn.LayerNorm(d_emb)
        self.lin1 = AmortisedLinearLayer(x_dim, y_dim, d_emb, d_emb, prior_type=1, inf_dims=inf_dims, nonlinearity=nn.Identity(), inf_net_use_act=inf_net_use_act)
        self.lin2 = AmortisedLinearLayer(x_dim, y_dim, d_emb, d_emb, prior_type=1, inf_dims=inf_dims, nonlinearity=nonlinearity, inf_net_use_act=inf_net_use_act)
